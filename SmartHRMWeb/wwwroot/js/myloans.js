...
function loadDataTable() {
    dataTable = $('#tblLoanData').DataTable({
        "ajax": {
            "url": "/Admin/Loan/GetAll"
        },
        "columns": [           
                ...
                "render": function (data) {
                    ...
                    return `<td class="align-middle white-space-nowrap text-end pe-0">
                            <div class="font-sans-serif btn-reveal-trigger position-static">
                              ...
                              <div class="dropdown-menu dropdown-menu-end py-2"><a class="dropdown-item" href="/Admin/Loan/Schedule?id=${data}">Schedule</a><a class="dropdown-item" href="/Admin/Loan/Upsert?id=${data}">Edit</a>
                                <div class="dropdown-divider"></div><a class="dropdown-item text-danger" onClick=Delete('/Admin/Loan/Delete/${data}')">Remove</a>
                              </div>
                            </div>
                          </td>`
                },
